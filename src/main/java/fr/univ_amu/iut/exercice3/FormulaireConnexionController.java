    ...
    BooleanBinding motDePasseInvalide =
        new BooleanBinding() {
          ...
          protected boolean computeValue() {
            ...
            boolean aucuneMajuscule = motDePasse.chars().noneMatch(Character::isUpperCase);
            boolean aucunChiffre = motDePasse.chars().noneMatch(Character::isDigit);
            return tropCourt || aucuneMajuscule || aucunChiffre;
          }
        };
